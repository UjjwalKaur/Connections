const combinations = [
    {name: "ELEMENTARY PARTICLES WITH SUFFIX- ON", elements: ["HYPER", "LEPT", "BOSS", "PHOTO"]},
    {name: "WORDS THAT SOUND DIFFERENT BUT ARE JUST SYNONYMS OF SRIRAM", elements: ["TOP", "ALPHA", "DOM", "ATOMIC BOMB"]},
    {name: "THINGS SARTHAK CAN DO BETTER", elements: ["READ", "SOLVE", "DANCE", "CHARM"]},
    {name: "CONCEPTS OF PHYSICS", elements: ["INTERFERE", "FORCE", "HOT", "POTENTIAL"]}
];
let attempts = 4;
